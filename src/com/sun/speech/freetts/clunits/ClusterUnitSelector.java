...
public class ClusterUnitSelector implements UtteranceProcessor {
	...
	static class Viterbi {
        ...
        Viterbi (Relation segs, ClusterUnitDatabase db) {
        ...
        int getFrameDistance (int a, int b, int[] joinWeights, int order) {
	...
	static class ViterbiPoint {
        ...
        void initDynamicPathArray (ViterbiCandidate candidate) {
			int i = 0;
