...
public class PathExtractorImpl implements PathExtractor {
	...
	private final static String INTERPRET_PATHS_PROPERTY = "com.sun.speech.freetts.interpretCartPaths";

	/** If this system property is set to true, CART feature/item paths will only be compiled as needed. */
	private final static String LAZY_COMPILE_PROPERTY = "com.sun.speech.freetts.lazyCartCompile";
	...
	public PathExtractorImpl(String pathAndFeature, boolean wantFeature) {
		...
		if (wantFeature) {
            ...
            boolean wantFeature1 = wantFeature;
		} else {
