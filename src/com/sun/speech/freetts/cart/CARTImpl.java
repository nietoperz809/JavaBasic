...
public class CARTImpl implements CART {
	...
	/** OPERAND_MATCHES */
	private final static String OPERAND_MATCHES = "MATCHES";
    ...
    private Node[] cart = null;

	/** The number of nodes in the CART. */
	private transient int curNode = 0;
	...
	private String dumpDotNodeColor (Node n) {
	...
	private String dumpDotNodeShape (Node n) {
		return "box";
	}
	 ...
	 * @return the node */
    private Node getNode (String type, StringTokenizer tokenizer, int currentNode) {
		if (type.equals(NODE)) {
	...
	static abstract class Node {
        ...
        void setCreationLine (String line) {
			creationLine = line;
		}
		...
		final void dumpBinary (DataOutputStream os) throws IOException {
	...
	abstract static class DecisionNode extends Node {
		...
		final int getNextNode (Item item) {
        ...
        DecisionNode (String feature, Object value, int qtrue, int qfalse) {
			super(value);
		...
		protected abstract int getNextNode (Object val);
	}
	...
	static class ComparisonNode extends DecisionNode {
        ...
        ComparisonNode (String feature, Object value, String comparisonType, int qtrue, int qfalse) {
	...
	static class MatchingNode extends DecisionNode {
		 ...
		 * @param qtrue the Node index to go to if the comparison matches
		 * @param qfalse the Node index to go to upon no match */
        MatchingNode (String feature, String regex, int qtrue, int qfalse) {
