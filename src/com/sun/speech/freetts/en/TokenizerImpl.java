...
public class TokenizerImpl implements Tokenizer {
	...
	private static final String DEFAULT_WHITESPACE_SYMBOLS = " \t\n\r";

	/** A string containing the default single characters. */
	private static final String DEFAULT_SINGLE_CHAR_SYMBOLS = "(){}[]";

	/** A string containing the default pre-punctuation characters. */
	private static final String DEFAULT_PREPUNCTUATION_SYMBOLS = "\"'`({[";

	/** A string containing the default post-punctuation characters. */
	private static final String DEFAULT_POSTPUNCTUATION_SYMBOLS = "\"'`.,:;!?(){}[]";
