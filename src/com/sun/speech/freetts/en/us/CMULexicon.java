...
public class CMULexicon extends LexiconImpl {
    ...
    private CMULexicon (URL compiledURL, URL addendaURL, URL letterToSoundURL, boolean binary) {
	...
	private CMULexicon (String basename, boolean useBinaryIO) {
	 ...
	 * @param useBinaryIO if true use binary IO to load DB
	 * @throws IOException if problems occurred while reading the data */
	private static CMULexicon getInstance (String basename, boolean useBinaryIO) throws IOException {
	...
	private static boolean isSilence (String phone) {
	...
	private static boolean hasVowel (String[] phones, int index) {
	 ...
	 * @return <code>true</code> if a vowel is found; otherwise <code>false</code>. */
	private static boolean hasVowel (List phones) {
