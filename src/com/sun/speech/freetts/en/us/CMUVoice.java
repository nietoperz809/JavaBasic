...
public abstract class CMUVoice extends Voice {
    ...
    CMUVoice (String name, Gender gender, Age age, String description, Locale locale, String domain,
    ...
    void setupFeatureSet () throws IOException {
    ...
    private void setupUtteranceProcessors () throws IOException {
    ...
    UtteranceProcessor getPostLexicalAnalyzer () throws IOException {
	 ...
	 * @throws IOException if an I/O error occurs */
    private void setupFeatureProcessors () throws IOException {
