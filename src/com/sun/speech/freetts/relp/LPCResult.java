...
public class LPCResult {
    ...
    private void dump (Writer writer) {
	 ...
	 * @param writer the output stream */
    private void dumpASCII (Writer writer) {
		Wave wave = getWave();
		wave.dump(writer);
	}
	...
	private static class Wave {
		...
		static final int DEFAULT_SAMPLE_SIZE_IN_BITS = 16;
