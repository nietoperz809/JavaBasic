...
public class LetterToSoundImpl implements LetterToSound {
    ...
    private void dumpBinary (String path) throws IOException {
	 ...
	 * @return the parsed <code>State</code> */
    private State getState (String type, StringTokenizer tokenizer) {
    ...
    private char[] getFullBuff (String word) {
    ...
    private boolean compare (LetterToSoundImpl other) {
	...
	static class DecisionState implements State {
        ...
        DecisionState (int index, char c, int qtrue, int qfalse) {
			this.index = index;
			this.c = c;
			this.qtrue = qtrue;
			this.qfalse = qfalse;
		 ...
		 * @throws IOException if an error occurs */
		static State loadBinary (DataInputStream dis) throws IOException {
			int index = dis.readInt();
			char c = dis.readChar();
